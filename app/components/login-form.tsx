                        ...
                        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm text-gray-100">
                            <form action={formAction} className="space-y-6" action="#" method="POST">
                                <div>
                                    ...
                                    <div className="mt-2">
                                        <input type="email" name="email" id="username" required className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-blue-600 sm:text-sm/6" />
                                    </div>
                                </div>
                                ...
                                <p className="mt-10 text-center text-sm/6 text-gray-500">
                                    Not a member?
                                    <a href="#" className="font-semibold text-indigo-600 hover:text-[#047ac0]"> Click Here to make an account.</a>
                                </p>
